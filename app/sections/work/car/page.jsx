...
export default function RaspberryPiCarPage() {
  ...
  const carProject = projectData.find((p) => p.id === 'raspberryPiCar');
  if (!carProject) {
    return (
      <>
        <Navbar />
  ...
  return (
    <>
      ...
      >
        {carProject.media[0].type === 'image' ? (
          <Image
            src={carProject.media[0].src}
            alt={carProject.media[0].alt || ''}
            fill
      ...
      >
        <div className="flex flex-col lg:flex-row items-center justify-between">
              ...
              <div className="flex-1">
                ...
                <div className="mt-0 lg:mt-2">
                  <SubTitle className="text-primary">
                    <ParallaxReveal paragraph={carProject.subtitle} />
                  </SubTitle>
                  <Paragraph2>
                    <ParallaxReveal paragraph={carProject.dateRange} />
                  </Paragraph2>
                </div>
              </div>
          ...
          <div className="w-full lg:w-[15%] flex justify-end space-x-2">
            <Link href={carProject.githubUrl} target="_blank" rel="noopener noreferrer">
              <MagneticButton
                size="lg"
              >
        ...
        <div className="mx-auto flex flex-col lg:flex-row px-4 pt-8 lg:px-0">
          ...
          <div className="w-full lg:w-[60%] space-y-5">
                ...
                <ul className="text-lg list-disc list-inside ml-4 space-y-4">
                  {carProject.techUsed.map((tech, idx) => (
                    <li key={idx}>
      ...
      >
        <div className="mx-auto w-[90%] lg:w-[70%] space-y-8">
          ...
          {carProject.media.slice(1).map((item, idx) => (
            <div
              key={idx}
