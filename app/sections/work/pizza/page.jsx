...
export default function Pizza() {
  ...
  const pizzaProject = projectData.find((p) => p.id === 'pizzaPoint');
  if (!pizzaProject) {
    return (
      <>
        <Navbar />
  ...
  return (
    <>
      ...
      >
        {pizzaProject.media[0].type === 'image' ? (
          <Image
            src={pizzaProject.media[0].src}
            alt={pizzaProject.media[0].alt || ''}
            fill
      ...
      >
        <div className="flex flex-col lg:flex-row items-center justify-between">
              ...
              <div className="flex-1">
                ...
                <div className="mt-0 lg:mt-2">
                  <SubTitle className="text-primary">
                    <ParallaxReveal paragraph={pizzaProject.subtitle} />
                  </SubTitle>
                  <Paragraph2>
                    <ParallaxReveal paragraph={pizzaProject.dateRange} />
                  </Paragraph2>
                </div>
              </div>
          ...
          <div className="w-full lg:w-[15%] flex justify-end space-x-2">
            <Link href={pizzaProject.githubUrl} target="_blank" rel="noopener noreferrer">
              <MagneticButton
                size="lg"
              >
            ...
            <Link href="https://github.com/YuvrajGupta1808/pizzashop" target="_blank" rel="noopener noreferrer">
              <MagneticButton
                size="lg"
              >
        ...
        <div className="mx-auto flex flex-col lg:flex-row px-4 pt-8 lg:px-0">
          ...
          <div className="w-full lg:w-[60%] space-y-5">
                ...
                <ul className="text-lg list-disc list-inside ml-4 space-y-4">
                  {pizzaProject.techUsed.map((tech, idx) => (
                    <li key={idx}>
      ...
      >
        <div className="mx-auto w-[90%] lg:w-[70%] space-y-8">
          ...
          {pizzaProject.media.slice(1).map((item, idx) => (
            <div
              key={idx}
